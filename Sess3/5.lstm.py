...
with tf.Session() as sess:
    ...
    # ========================================================================Start
    _current_cell_state = np.zeros((state_size))
    _current_hidden_state = np.zeros((state_size))
    # ========================================================================End
    predictions_series, prediction_numbers = sess.run([predictions_series, prediction_numbers],
            feed_dict={
                ...
                cell_state: _current_cell_state.reshape((-1, state_size)),
                hidden_state: _current_hidden_state.reshape((-1, state_size))
            })
